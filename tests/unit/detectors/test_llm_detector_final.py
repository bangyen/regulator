...
class TestLLMDetectorInitialization:
    ...
    def test_init_llm_model_mocked(self) -> None:
        ...
        with patch("regulator.detectors.llm_detector.openai") as mock_openai:
...
class TestLLMDetectorLLMModel:
    ...
    def test_llm_model_initialization(self) -> None:
        ...
        with patch("regulator.detectors.llm_detector.openai") as mock_openai, patch(
            "regulator.detectors.llm_detector.os.getenv"
        ) as mock_getenv:
