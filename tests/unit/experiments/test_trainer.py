...
class TestTrainAndEvaluateDetector:
    ...
    @patch("regulator.experiments.trainer.generate_synthetic_labels")
    @patch("regulator.experiments.trainer.FeatureExtractor")
    @patch("regulator.experiments.trainer.CollusionDetector")
...
class TestTrainMlDetector:
    ...
    @patch("regulator.experiments.trainer.create_demo_episodes")
    @patch("regulator.experiments.trainer.train_and_evaluate_detector")
    @patch("regulator.experiments.trainer.print")
